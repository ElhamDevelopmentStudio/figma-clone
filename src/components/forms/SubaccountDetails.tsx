...
//For future reference we should also create an additional feature that gives access for Subaccount Guests and they should see a different view maybe a form that allows them to create tickets

//ALso layout.tsx only runs once as a result if you remove permissions for someone and they keep navigating the layout.tsx wont fire again. one solution would be to save the data inside metadata for current user.
